...
export function DeleteChatDialog({ chatId, userId, dispatch }: DeleteChatDialogProps) {
    ...
    return (
        <DialogContent>
            ...
            <DialogFooter>
                <DialogClose asChild>
                    <Button disabled={deleteMutation.isPending || transitioning} variant="outline">
                        Cancel
                    </Button>
                </DialogClose>
                <Button
                ...
                >
                    {(deleteMutation.isPending || transitioning) && <IconSpinner className="mr-2 animate-spin" />}
                    Delete
                </Button>
            </DialogFooter>
        </DialogContent>
