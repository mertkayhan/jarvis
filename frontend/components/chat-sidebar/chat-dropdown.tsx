                ...
                <DropdownMenuGroup>
                    ...
                    <DialogTrigger asChild>
                        <DropdownMenuItem onClick={() => {
                            ...
                            <IconEdit />
                            <span className="px-2 text-sm">Rename</span>
                            <span className="sr-only">Modify chat title</span>
                        </DropdownMenuItem>
                    </DialogTrigger>
                    <DialogTrigger asChild>
                        <DropdownMenuItem onClick={() => {
